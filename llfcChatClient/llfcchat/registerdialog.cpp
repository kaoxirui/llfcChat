...
//         QJsonObject json_obj;
//         json_obj["email"] = email;
//         HttpMgr::GetInstance()->PostHttpReq(QUrl("http://localhost:8080/get_varifycode"), json_obj,
...
void RegisterDialog::on_sure_btn_clicked() {
    ...
    HttpMgr::GetInstance()->PostHttpReq(QUrl("http://localhost:8080/user_register"), json_obj,
                                        ReqId::ID_REG_USER, Modules::REGISTERMOD);
}
